...
I do a mix of interface design, data collection, and data analysis for [Anthropic](https://www.anthropic.com)'s human feedback program. We want to use use human feedback data to align large language models with human intent,  without causing harm.
